...
test_that("POSIXct/ POSIXlt datetime works", {
  expect_equal(classify_vector(sample(as.POSIXct(c("2000-12-12 00:12:33",
                                                   "3000-01-01 11:11:23",
                                                   "0110-02-22 00:00:01",
                                                   NA)), 100, replace = TRUE), cat_thres = 102), "datetime")
  expect_equal(classify_vector(sample(as.POSIXct(c("2000-12-12 00:12:33",
                                                   "3000-01-01 11:11:23",
                                                   "0110-02-22 00:00:01",
                                                   NA)), 100, replace = TRUE), cat_thres = 10), "datetime")
  expect_equal(classify_vector(sample(as.POSIXlt(c("2000-12-12 00:12:33",
                                                   "3000-01-01 11:11:23",
                                                   "0110-02-22 00:00:01",
                                                   NA)), 100, replace = TRUE)), "datetime")
...
test_that("Dates work", {
  expect_equal(classify_vector(sample(as.Date(c("2000-12-12",
                                                   "3000-01-01",
                                                   "0110-02-22",
                                                   NA)), 100, replace = TRUE), cat_thres = 102), "date")
  expect_equal(classify_vector(sample(as.Date(c("2000-12-12",
                                                "3000-01-01",
                                                "0110-02-22",
                                                NA)), 100, replace = TRUE), cat_thres = 10), "date")
  expect_equal(classify_vector(sample(as.Date(c("2000-12-12",
                                                "3000-01-01",
                                                "0110-02-22",
                                                NA)), 100, replace = TRUE)), "date")
